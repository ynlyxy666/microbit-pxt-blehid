...
const int numReportsMax = 1;
const int reportMapMaxSize = 40;  // Enough for media
const int reportMaxSize = 1;       // Max size for media
...
class HIDService : public MicroBitBLEService
{
  ...
  private:
    ...
    typedef enum mbbs_cIdx
    {
        ...
        mbbs_cIdxHIDInfo,
        mbbs_cIdxReportMap,
        mbbs_cIdxReport1,  // Only need one report for media
        mbbs_cIdxCOUNT
    } mbbs_cIdx;
